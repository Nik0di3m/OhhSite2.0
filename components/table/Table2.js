        ...
        <TableContainer>
            ...
            <div className="divTable unstyledTable">
                ...
                <div className="divTableBody">
                    ...
                    <div className="divTableRow">
                        <div className="divTableCell">Pozycjonowanie fraz long-tail</div>
                        <div className="divTableCell"></div>
                        <div className="divTableCell"></div>
                        <div className="divTableCell"></div>
                        <div className="divTableCell">✔</div>
                    ...
                    <div className="divTableRow">
                        <div className="divTableCell">Unikalne opisy produktów</div>
                        <div className="divTableCell"></div>
                        <div className="divTableCell"></div>
                        <div className="divTableCell"></div>
                        <div className="divTableCell"></div>
                    ...
                    <div className="divTableRow">
                        <div className="divTableCell">Analiza porzuconych koszyków</div>
                        <div className="divTableCell"></div>
                        <div className="divTableCell"></div>
                        <div className="divTableCell"></div>
                        <div className="divTableCell">✔</div>
                    ...
                    <div className="divTableRow">
                        ...
                        <div className="divTableCell">70</div>
                        <div className="divTableCell">90</div>
                        <div className="divTableCell">150</div>
                        <div className="divTableCell">250</div>
                    </div>
                    <div className="divTableRow">
                ...
                <div className="divTableFoot tableFootStyle">
                    <div className="divTableRow">
                        ...
                        <div className="divTableCell">2499zł</div>
                        <div className="divTableCell">3999zł</div>
                    </div>
                </div>
            </div>
        </TableContainer>
